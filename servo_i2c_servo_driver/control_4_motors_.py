...
slider2 = tk.Scale(root, from_=70, to=180, orient=tk.HORIZONTAL, length=300, command=lambda value: update_angles(1, value))
slider3 = tk.Scale(root, from_=130, to=180, orient=tk.HORIZONTAL, length=300, command=lambda value: update_angles(2, value))
